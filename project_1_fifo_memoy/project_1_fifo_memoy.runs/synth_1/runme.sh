...
HD_PWD='/home/lauro199471/Documents/VHDL-Tutorial/project_1_fifo_memoy/project_1_fifo_memoy.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log myFIFO_tb.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source myFIFO_tb.tcl
