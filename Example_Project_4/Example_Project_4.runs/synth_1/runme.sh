...
HD_PWD='/home/lauro199471/Documents/VHDL-Tutorial/Example_Project_4/Example_Project_4.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log simple_design_tb.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source simple_design_tb.tcl
